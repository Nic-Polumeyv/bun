...
extern "C" fn on_data(
    ...
    for i in 0..packets {
        ...
        this.maybe_announce_provisional(
            global,
            payload,
            (peer as *const _ as *const c_void).cast(),
        );
...
unsafe extern "C" fn on_mini_conn_failed(
    owner: *mut c_void,
...
unsafe extern "C" fn packets_out(
    owner: *mut c_void,
...
unsafe extern "C" fn get_ssl_ctx(
    owner: *mut c_void,
    _local: *const c_void,
) -> *mut lsquic::SSL_CTX {
    if owner.is_null() {
...
unsafe extern "C" fn lookup_cert(
    owner: *mut c_void,
    local: *const c_void,
    sni: *const c_char,
) -> *mut lsquic::SSL_CTX {
